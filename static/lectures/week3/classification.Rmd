...
output:
  xaringan::moon_reader:
    css: ["kunoichi", "ninjutsu", "../../../assets/mystyle.css"]
    lib_dir: libs
    nature:
      ratio: '16:9'
...
ggplot(data, aes(x=x, y=y, color=Link))+geom_line(size=1.4) + xlab(TeX('$\\beta_0 + \\beta_1 x$')) +  ylab(TeX('$p(y=1|\\beta_0 + \\beta_1 x) = f(\\beta_0 + \\beta_1 x)$')) + theme(text = element_text(size=18))
```
