...
DLDA is easy to run, is found in the `dlda` function provided by the `sparsediscrim` package (hosted on GitHub)
---
...
NSC can be used through the `pamr` function in R. It requires cross-validation to select the parameter $\Delta$.
