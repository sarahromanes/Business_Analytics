...
<center>
<a href="http://www-bcf.usc.edu/~gareth/ISL/Chapter4/4.8.pdf" target="_BLANK"> <img src="images/4.8.png" style="width: 50%; align: center"/> </a>
</center>
...
.center[.font_small[(left) LDA and SVM similar.        (right) SVM radial basis with `\\(\gamma=10^{-1}\\)` is the best. ]]
